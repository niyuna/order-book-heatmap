export default class TSEDataFeed {
  ...
  startDataSimulation(subscription) {
    ...
    if (subscription.lastEndTime) {
      ...
      // 如果市场关闭且没有上次的结束时间，使用2025年4月11日9点30分
      const defaultDate = new Date('2025-04-11T09:30:00+09:00');
      startTime = defaultDate.getTime();
    }
  ...
  convertToBinanceTradeFormat(trade) {
    ...
    return {
      ...
      m: !trade.isBuyerMaker // Binance 中 m=true 表示卖方发起
    };
  }
